...
This guide explains the ordering options required when purchasing **Airbus SAR (TerraSAR‑X / TanDEM‑X)** commercial data in the EODH interface. It focuses on SAR‑specific choices and uses terminology taken directly from the TerraSAR‑X Image Product Guide and DLR TerraSAR‑X orbit specifications.

---

## **Product Bundle (Airbus SAR Processing Levels)**
...
[1](https://www.intelligence-airbusds.com/files/pmedia/public/r2116_9_int_020_terrasar-x_en_low.pdf)

### **MGD — Multi‑Look Ground Detected**  
...
## **Projection (Product Geometry)**

Projection options determine the spatial reference system applied to the delivered SAR product.  
**Determines the projection of the data in space. Can be easily converted in most GIS systems later.**

> **“The standard cartographic projections for TerraSAR‑X Basic and Enhanced Image Products are Universal Transversal Mercator (UTM) and Uniform Polar Stereographic (UPS) with WGS84 ellipsoid.”**

### **Projection Options in EODH**
...
[2](https://forum.sentinel-hub.com/t/new-eo-browser-feature-commercial-data-ordering/4226)
